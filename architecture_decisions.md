...
- **Implementation:** Markdown files + Claude Code skills, not Python + the Agents software development kit.
...
- **Pattern:** A classic three-stage pipeline — **Collect → Evaluate → Classify** (gather, transform, invert) — using the ubiquitous language from the brief.
